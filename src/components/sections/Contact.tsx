  ...
  return (
    <div className={`relative ${isDarkMode ? "bg-[#000000]" : "bg-[#F2F7FF]"}`}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        ...
        >
          <h2
            className={`text-3xl sm:text-4xl font-bold mb-4 font-space-grotesk ${
        ...
        <div className="flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto">
          ...
          >
            <form
              ...
              className={`rounded-lg p-6 sm:p-8 shadow-md ${
                isDarkMode
                  ? "bg-[#0A0A0A]/80 border border-[#146C94]/30"
                  : "bg-white/90 border border-[#0B409C]/10"
              }`}
            >
              <div className="mb-6">
                <label
          ...
          >
            <div
              className={`rounded-lg p-6 sm:p-8 h-full shadow-md ${
                isDarkMode
                  ? "bg-[#0A0A0A]/80 border border-[#146C94]/30"
                  : "bg-white/90 border border-[#0B409C]/10"
              }`}
            >
              <h3
                className={`text-xl font-bold mb-6 font-space-grotesk ${
                  isDarkMode ? "text-[#F6F1F1]" : "text-[#10316B]"
                }`}
              >
                Contact Information
