    ...
    <div className="relative h-full flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="text-center">
          <motion.h1
            className={`font-space-grotesk text-4xl sm:text-5xl md:text-6xl font-bold mb-6 ${
              isDarkMode
          ...
          <div className="h-24 sm:h-28 md:h-32 mb-8 relative">
            <AnimatePresence mode="wait">
              {isTypingComplete && (
                ...
                >
                  <p
                    className={`font-space-grotesk text-xl sm:text-2xl md:text-3xl font-medium ${
                      isDarkMode
                  ...
                  <p
                    className={`font-jetbrains-mono text-sm sm:text-base md:text-lg mt-2 ${
                      isDarkMode ? "text-[#19A7CE]/80" : "text-[#0B409C]/80"
                    }`}
                  >
      ...
      <div className="absolute bottom-10 left-0 right-0 flex justify-center z-20">
        ...
        >
          <motion.p
            className={`font-space-grotesk text-sm mb-2 font-medium ${
              isDarkMode
