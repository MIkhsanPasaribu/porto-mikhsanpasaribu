...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <body
        className={`${inter.variable} ${spaceGrotesk.variable} ${jetbrainsMono.variable} font-inter bg-[#F2F7FF] dark:bg-[#000000] text-[#10316B] dark:text-[#F6F1F1] transition-colors duration-200`}
      >
        <ThemeProvider>
          {children}
          <ThemeSwitcher />
