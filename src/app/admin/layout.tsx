  ...
  return (
    <div
      className={`min-h-screen flex overflow-hidden ${
        isDarkMode ? "bg-[#000000]" : "bg-[#F2F7FF]"
      }`}
    >
      {/* Sidebar for desktop */}
        ...
        >
          ...
          <div
            className={`flex-shrink-0 flex border-t p-4 ${
              isDarkMode ? "border-[#146C94]/20" : "border-[#0B409C]/10"
            }`}
          >
            <button
              onClick={handleLogout}
              className={`flex-shrink-0 group w-full flex items-center px-2 py-2 text-base font-medium rounded-md ${
                isDarkMode
                  ? "text-[#F6F1F1]/70 hover:bg-[#146C94]/10 hover:text-[#F6F1F1]"
                  : "text-[#10316B]/70 hover:bg-[#0B409C]/5 hover:text-[#10316B]"
              }`}
      ...
      <div className="md:hidden">
        <div
          className={`fixed top-0 left-0 right-0 z-30 flex items-center h-16 px-4 ${
            isDarkMode
      ...
      <div className="flex flex-col w-0 flex-1 overflow-hidden">
        <main className="flex-1 relative overflow-y-auto focus:outline-none">
          <div className="md:py-6 md:px-8 pt-16 md:pt-0">{children}</div>
        </main>
      </div>
    </div>
  );
